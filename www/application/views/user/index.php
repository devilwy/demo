...
<body>
<div><?php echo $username;?>,欢迎您，来到个人中心,
<a href="<?php echo site_url('user/userinfo');?>">个人设置</a>&nbsp;&nbsp;<a href="<?php echo site_url('user/changepwd');?>">修改密码</a>&nbsp;&nbsp;<a href="<?php echo site_url('user/logout'); ?>">退出</a></div>
